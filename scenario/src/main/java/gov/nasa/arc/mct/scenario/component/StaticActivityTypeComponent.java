 ...
 *
 */
public class StaticActivityTypeComponent extends AbstractActivityTypeComponent {
	private List<CostCapability> internalCosts = 
			Arrays.<CostCapability> asList(
					new CommActivityTypeCost(),
					new StaticPowerActivityTypeCost()); 
	...
	private class StaticPowerActivityTypeCost extends PowerActivityTypeCost {
