...
public class ExampleComponentProvider extends AbstractComponentProvider {
	...
	private static ResourceBundle bundle = ResourceBundle.getBundle("ExampleResourceBundle"); //look at src/main/resources in the ExampleResourcesBundle
	...
	public ExampleComponentProvider() {
		...
		exampleComponentType = new ComponentTypeInfo(
				...
				ExampleComponent.class, new SatelliteWizard()); //Harleigh_PI: this pops-up the wizard
